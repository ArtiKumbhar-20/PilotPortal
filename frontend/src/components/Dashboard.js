            ...
            {userDetails ? (
              <>
                ...
                <div className='row mt-4'>
                  <div className='col-6'>
                  <NavLink to='/IdeaEvaluation' className="btn btn-style-one"> <span>Evaluated Ideas</span> </NavLink>
                  </div>
                  <div className='col-6'>
                  <NavLink to='/IdeaEvaluation' className="btn btn-style-one"> <span>Start Evaluation</span> </NavLink>
                  </div>
                </div>
              </>
            ) : (
