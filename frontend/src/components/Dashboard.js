          ...
          <div class='main container'>
            ...
            >
              ...
              <div className='row'>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team Name : <span>{team.teamName}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team CEO : <span>{team.teamCEO}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team COO : <span>{team.teamCOO}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team CMO : <span>{team.teamCMO}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team CTO : <span>{team.teamCTO}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
                    Team CFO : <span>{team.teamCFO}</span>
                  </label>
                </div>
                <div className='col-12 col-xl-6 col-lg-6 col-sm-12 mb-3'>
                  <label className='labelStyle'>
