...
export default function EventForm() {
  ...
  const sendEventDetails = (event) => {
    ...
    const newFormErrors = {
      ...
      eventSPOCMobile: validateRequired(eventSPOCMobile),
      eventSPOCWhatsapp: validateRequired(eventSPOCWhatsapp),
              ...
              <div className='row'>
                ...
                <div className='col-12 col-xl-6 col-lg-6 mb-3'>
                  ...
                  <input
                    type='date'
                    className={
                      "form-control " + (formErrors.eventStartDate ? "is-invalid" : "")
                    }
                    name={eventStartDate}
                    onChange={(e) => {
                      const value = e.target.value;
                ...
                <div className='col-12 col-xl-6 col-lg-6 mb-3'>
                  ...
                  <input
                    type='time'
                    className={
                      "form-control " + (formErrors.eventStartTime ? "is-invalid" : "")
                    }
                    name={eventStartTime}
                    onChange={(e) => {
                      const value = e.target.value;
                ...
                <div className='col-12 col-xl-6 col-lg-6 mb-3'>
                  ...
                  <input
                    type='date'
                    className={
                      "form-control " + (formErrors.eventEndDate? "is-invalid" : "")
                    }
                    name={eventEndDate}
                    onChange={(e) => {
                      const value = e.target.value;
                ...
                <div className='col-12 col-xl-6 col-lg-6 mb-3'>
                  ...
                  <input
                    type='time'
                    className={
                      "form-control " + (formErrors.eventEndTime? "is-invalid" : "")
                    }
                    name={eventEndTime}
                    onChange={(e) => {
                      const value = e.target.value;
                ...
                <div className='col-12 col-xl-12 col-lg-12 mb-3'>
                  ...
                  <input
                    type='name'
                    className={
                      "form-control " + (formErrors.eventGuidelines? "is-invalid" : "")
                    }
